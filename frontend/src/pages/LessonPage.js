...
export default function LessonPage() {
  ...
  const banners = {
    visual: { bg: "bg-[#FAFAFA]", text: "text-white", msg: "🔊 Text-to-speech active - content will be read aloud automatically" },
        ...
        {phase === "quiz" && currentQuestion && (
          <div className="space-y-6" data-testid="lesson-quiz-phase">
            ...
            <button
              ...
              disabled={!selected}
              className={`neura-btn text-lg w-full disabled:opacity-40 ${disability === "motor" ? 'h-20 text-xl' : 'h-14'} ${
