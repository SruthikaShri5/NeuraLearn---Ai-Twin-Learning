...
export default function KnowledgeGraphPage() {
  ...
  }, [concepts, mastery, filterSubject]); // eslint-disable-line react-hooks/exhaustive-deps
          ...
          <>
            ...
            {selected && (
              <div className="absolute bottom-4 left-4 right-4 sm:left-auto sm:right-4 sm:w-80 neura-card p-5" data-testid="kg-concept-detail">
                ...
                <Link to={`/lesson/${selected.id?.replace("math_", "lesson_").replace("sci_", "lesson_")}_1`}>
