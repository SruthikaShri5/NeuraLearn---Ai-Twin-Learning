...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex" style={{ background: "#FAFAFA", color: "#1A1A2E" }} data-testid="login-page">
      <main id="main-content" className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-md">
          <Link to="/" className="flex flex-col items-center gap-1 mb-8 justify-center" data-testid="login-logo-link">
