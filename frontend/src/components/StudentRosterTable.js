            ...
            <div
              ...
              className={`rounded-xl p-3 sm:p-4 flex flex-col sm:grid sm:grid-cols-[2fr_1fr_1fr_1fr_1fr_auto] gap-3 items-start sm:items-center ${
                isJunior
                  ...
                  : "bg-white border border-[#E5E7EB] hover:border-[#118AB2] transition-colors"
              }`}
            ...
            >
              ...
              <div className="flex flex-col items-center sm:text-center">
                <div className="flex items-center gap-1">
                  <Zap className={`w-3.5 h-3.5 ${isJunior ? "text-[#b8860b]" : "text-amber-400"}`} />
                  <span className={`text-sm font-bold ${isJunior ? "text-[#118AB2]" : "text-[#4F46E5]"}`}>
                    {student.xp || 0}
                  </span>
                </div>
                {student.learning_profile?.learning_style && (
                  <span className={`text-[9px] font-black uppercase px-1 rounded mt-0.5 ${
                    isJunior ? "bg-[#118AB2]/10 text-[#118AB2]" : "bg-[#4F46E5]/10 text-[#4F46E5]"
                  }`}>
                    {student.learning_profile.learning_style}
                  </span>
                )}
